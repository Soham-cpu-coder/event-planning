                    ...
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            ...
                            <p class="definition"><!--event content definition-->
                             Welcome to the world of official adulthood—where the drinks are legal,
                              but the responsibilities get real! Wishing you an unforgettable night filled with laughter, good vibes, and maybe just a little bit of chaos.
                              Enjoy every moment—tonight is all about YOU! Cheers to 21!
                            </p>
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            ...
                            <p class="definition"><!--event content definition-->
                            "Get ready to turn heads! 🔥✨ This is your chance to bring out your best look—because at Joe’s 21st, 
                            the dress code is DRESS TO IMPRESS! Suit up, glam up, and let’s celebrate in style. See you there! 🍾🥂"
                            </p>
                            <hr class="customline2"><!--css modified horizontal line-->
                            <button type="button" class="btn btn-default btn-lg"><!--view details button (no function implemented)-->
                            View Details  <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span><!--arrow right glyphicon-->
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            ...
                            <p class="location"><!--event content location-->
                            Galaxy Banquet Hall, Belapur
                            </p>
                            <p class="definition"><!--event content definition-->
                             Two years down, a lifetime to go! Whether it’s been laughter, challenges, or unforgettable moments, every second has been worth it. 
                            Here’s to growing stronger, loving deeper, and creating even more beautiful memories together. Cheers to us and to many more anniversaries ahead! 
                            </p>
                            <hr class="customline2"><!--css modified horizontal line-->
                            <button type="button" class="btn btn-default btn-lg"><!--view details button (no function implemented)-->
                            View Details  <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span><!--arrow right glyphicon-->
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            ...
                            <p class="location"><!--event content location-->
                            The Vista Room,Kharghar
                            </p>
                            <p class="definition"><!--event content definition-->
                             Discover insights, strategies, and real-world advice from industry experts who have been where you are and know what it takes to succeed.
                             Whether you're exploring career paths, seeking motivation, or looking to level up your professional game, this is an opportunity you don’t want to miss
                            </p>
                            <hr class="customline2"><!--css modified horizontal line-->
                            <button type="button" class="btn btn-default btn-lg"><!--view details button (no function implemented)-->
                                View Details  <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span><!--arrow right glyphicon-->
