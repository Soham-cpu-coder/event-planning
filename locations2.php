            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-8"><!--location non modal content -->
                            <h1 class="title">Bar Mystery</h1><!--location title-->
                            <p class="location">Kalyan</p><!--location secondary content-->
                            <p class="definition">
                            BAR Mystery is the Kalyan's Sophisticate’s adult playground.
                ...
                <section>
                    <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                ...
                                                <p>
                                                There’s no question that The Rocks is home to some of Belapur's most intriguing historical stories. And
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">Galaxy Banquet Hall</h1>
                            <p class="location">Belapur</p>
                            <p class="definition">There’s no question that The Rocks is home to some of Belapur's most intriguing historical stories.
                                And our landmark venue, Galaxy Banquet Hall, has a unique, rich history all of its own. The sandstone walls that house
                                Galaxy Banquet Hall had seen some interesting sights well before we all hit the dance floor.</p>
            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            ...
                                            <div class="modaltext2 col-md-12">
                                                ...
                                                over 900 people and is located opposite the Kharghar Convention & Exhibition Centre, overlooking Melbourne’s South Wharf
                                                Promenade.
                                                </p>
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">The Vista Room</h1>
                            <p class="location">Kharghar</p>
                            <p class="definition">The uber venue is our latest venture, bringing to life a traditional
                                ...
                                The state-of-the-art venue seats over 900 people and is located opposite the Kharghar
                                Convention & Exhibition Centre, </p>
                            <hr class="customline3">   
